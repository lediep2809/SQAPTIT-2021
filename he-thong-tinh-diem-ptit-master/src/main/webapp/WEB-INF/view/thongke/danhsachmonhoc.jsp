...
<section id="body">
    <div class="container mt-5">
        <form>
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <form:select path="listMonHoc" id="selectBox1"
                        ...
                        <form:option value="/thongke" label="Lựa chọn"></form:option>
                        <c:forEach var="item" items="${listMonHoc }">
                            <c:url value="/thongke/${item.maMonHoc }" var="selectedLink1">
                            </c:url>
                ...
                <c:if test="${not empty selectedId }">
                    <div class="form-group col-md-4">
                        ...
                        <form:select path="listNhomMonHoc" id="selectBox2"
                            ...
                            <form:option
                                    value="${pageContext.request.contextPath}/thongke/${selectedId }"
                                    label="Lựa chọn"></form:option>
                            <c:forEach var="item" items="${listNhomMonHoc }">
                                <c:url value="/thongke/${selectedId }/${item.nhomMonHoc }" var="selectedLink2">
                                </c:url>
            ...
            <a class="btn btn-info px-5" href="/thongke/dsmh">Reset</a>
        </form>
                ...
                <c:forEach var="item" items="${listMonHocs }" varStatus="count">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:url value="/thongke/${selectedId }/${item.nhomMonHoc }/dssv" var="urlLink">
