...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
                        ...
                        if (r(S)) {
                            ...
                            for (var M in c.visibility !== n && "hidden" !== c.visibility && y.setPropertyValue(S, "visibility", c.visibility), k) if ("element" !== M) {
                                ...
                                if (1 === m) P = T.endValue; else {
                                    ...
                                    if (P = T.startValue + I * A(m, c, I), !p && P === T.currentValue) continue
                                }
                        ...
                        default:
                            if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                                if (f.isString(b) && v.Redirects[b]) {
                                    var I = (O = d.extend({}, w)).duration, _ = O.delay || 0;
                                    return !0 === O.backwards && (m = d.extend(!0, [], m).reverse()), d.each(m, function (t, e) {
                                        parseFloat(O.stagger) ? O.delay = _ + parseFloat(O.stagger) * t : f.isFunction(O.stagger) && (O.delay = _ + O.stagger.call(e, t, S)), O.drag && (O.duration = parseFloat(I) || (/^(callout|transition)/.test(b) ? 1e3 : g), O.duration = Math.max(O.duration * (O.backwards ? 1 - t / S : (t + 1) / S), .75 * O.duration, 200)), v.Redirects[b].call(e, e, O || {}, t, S, m, T.promise ? T : n)
                                    }), t()
                                }
                        ...
                        if (r.each(m, function (n, a) {
                            if (!r.isNullOrUndef(n.label)) {
                                ...
                                if (g) {
                                    ...
                                    W < e.left && (d = "rgba(0,0,0,0)"), W += r.aliasPixel(u), O = e.getPixelForTick(a) + s.labelOffset, v = y = k = C = W, b = _, x = D, S = t.top, F = t.bottom + T
                                } else {
                                    ...
                                    j < e.top && (d = "rgba(0,0,0,0)"), j += r.aliasPixel(u), L = e.getPixelForTick(a) + s.labelOffset, v = A, y = I, k = t.left, C = t.right + T, b = x = S = F = j
                                }
                                P.push({
                                    tx1: v,
                                    ty1: b,
    ...
    t(e).each(function (e, n) {
        ...
        var i = t(e.target), a = !i.val(), r = !e.target.validity.badInput, o = void 0 === i.attr("placeholder");
